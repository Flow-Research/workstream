...
| Planning intake cannot enter signed history | Critical | Filter only directory entries from the GitHub recursive tree map, preserve every non-tree identity, and recover exact PR #187 plus 00R1 through a consumed two-merge certificate. |
