...
|---|---:|---|
| A semantic dependency is missed despite disjoint paths | Critical | Closed boundary manifests; unknown impact invalidates all relevant tracks. |
...
| Upstream finding is falsely marked resolved | High | Require deterministic target predicate; otherwise rerun owning track. |
