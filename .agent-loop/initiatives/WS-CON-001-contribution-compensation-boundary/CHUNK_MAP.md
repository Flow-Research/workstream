...
| `WS-ARCH-001-CP02` | Hidden adapter-binding lifecycle behavior | Complete; actions remain unavailable |
...
REV-04B + 03B -> 03C -> 03D
CP01A -> CP01B -> CP01C -> CP02 -> CP03A -> CP03B -> CP04A -> CP04B -> CP05 -> CP06 -> CP07 -> CP08
