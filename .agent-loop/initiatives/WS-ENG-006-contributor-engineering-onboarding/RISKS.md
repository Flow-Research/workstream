...
| Root repair authorizes itself too broadly | A reusable exception could bypass later starts | Retarget the exact-single-target recovery certificate to initiative/chunk, require signed first parent and one-target reconciliation, then consume it and reject reuse. |
