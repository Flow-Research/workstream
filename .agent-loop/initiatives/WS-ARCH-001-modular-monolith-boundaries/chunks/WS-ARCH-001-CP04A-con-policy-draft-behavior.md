...
| Update rejects a non-UUID required version selector before repository access | CONTRIBUTIONS request boundary | `tests/contributions/test_policy_draft_update.py::test_update_draft_rejects_non_uuid_required_version_selector` | focused local command and hosted CI |
