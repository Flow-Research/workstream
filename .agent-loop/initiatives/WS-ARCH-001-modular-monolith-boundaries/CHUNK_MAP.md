...
| `WS-ARCH-001-02C` | CHECKERS effective pre-submit plan and bounded execution-result public facts/ports | L1 | Next durable boundary until merged; open PRs show transient ownership |
