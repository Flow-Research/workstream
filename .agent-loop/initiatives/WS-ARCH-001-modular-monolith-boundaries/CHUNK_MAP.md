...
| `WS-ARCH-001-03B` | TASK claim, assignment and locked-context public commands/facts | L1 | Planned skeleton after 03A |
| `WS-ARCH-001-03C` | AUTH-13 task/assignment activation and integrated readiness proof | L1 | Planned skeleton after 03A/03B hidden manifests |
