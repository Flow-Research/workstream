...
|---|---|---:|---|
| `WS-ARCH-001-01` | Canonical module map, exact general edge ledger, public-API validator, and CI foundation | L1 | Proposed |
| `WS-ARCH-001-02` | AUTH/ART/TASK submission preparation and ready-admission consumption public capabilities | L1 | Proposed after 01 and XINT-05A reconciliation |
...
Chunks 02-06 are coordination contracts, not permission to combine an entire
product milestone into one PR. Each is split further when its exact feature
contract crosses more than one reviewable mutation boundary.
