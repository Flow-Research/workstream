...
| `WS-ARCH-001-CP02` | CON hidden adapter-binding behavior | L1 | Proposed executable contract; implementation requires planning merge and explicit human approval |
