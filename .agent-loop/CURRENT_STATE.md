...
| [WS-CI-005](initiatives/WS-CI-005-semantic-proof-quality/STATUS.md) | Proof-strength custody and escaped-defect learning are planned; no implementation behavior exists | Start `WS-CI-005-01` only through explicit human direction |
