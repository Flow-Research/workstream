...
| [WS-AUTH-001](initiatives/WS-AUTH-001-workstream-authorization-service/STATUS.md) | Active delivery initiative; AUTH-12J completes exact request-local authority for hidden POL-04A3 projections | AUTH-12B2 waits only for hidden POL-04A2 and owns the later concrete finalization-adapter revocation and receipt-integrity proof |
...
| [WS-CI-004](initiatives/WS-CI-004-review-evidence-integrity/STATUS.md) | Exact-target, nine-reviewer, final-head, impact-cone, adversarial-proof, and semantic-completeness work is complete | Preserve the merged review-evidence protocol; future changes require a new bounded contract |
...
actions active. CP04A/CP04B are complete; later CP05-CP09
remain non-executable until their current-main contracts are expanded.
...
- WS-ARCH-001-CP03B is complete: exactly four hidden adapter-binding
  ...
  activated.
- WS-ARCH-001-CP04 is a planned non-executable parent. CP04A and CP04B are
  complete; CP05 is the next planning boundary.
...
- WS-ARCH-001-CP04B is complete with hidden publication/retirement.
- WS-ARCH-001-CP05 is next and remains non-executable pending its contract.
