...
|---|---|---|
| [WS-ART-001](initiatives/WS-ART-001-immutable-artifact-storage/STATUS.md) | Active delivery initiative; admission foundations are merged through `04C1` | Continue dependency-ordered artifact custody and v0.1 conformance; use open PRs for transient ownership |
...
| [WS-POL-003](initiatives/WS-POL-003-unified-project-guide-compilation/STATUS.md) | Active delivery initiative; plan reconciliation and contract catalogue are merged through `01` | Continue unified compilation and later persistence and approval integration in dependency order |
