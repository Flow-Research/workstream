...
| [WS-POL-003](initiatives/WS-POL-003-unified-project-guide-compilation/STATUS.md) | Active delivery initiative; contract catalogue and unified guide adapter are merged through `02` | Continue hidden compilation persistence and later approval integration in dependency order |
