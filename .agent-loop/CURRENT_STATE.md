...
| [WS-CI-005](initiatives/WS-CI-005-semantic-proof-quality/STATUS.md) | `WS-CI-005-PLAN` and `WS-CI-005-01` are complete; `WS-CI-005-02` and `WS-CI-005-03` are planned and inactive | Start `WS-CI-005-02` only through explicit human direction |
