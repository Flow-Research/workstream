...
|---|---|---|
| [WS-ARCH-001](initiatives/WS-ARCH-001-modular-monolith-boundaries/STATUS.md) | Boundary foundation and TASK, PROJECT, CHECKER, ART hidden preparation, and ART admission-consumption public capabilities are complete through `WS-ARCH-001-02E`; no product route or AUTH action was activated | `WS-ARCH-001-02F` is the TASK-owned immutable Submission command and hidden composed transaction |
