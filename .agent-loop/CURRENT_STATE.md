...
|---|---|---|
| [WS-ARCH-001](initiatives/WS-ARCH-001-modular-monolith-boundaries/STATUS.md) | `WS-ARCH-001-02C` is complete on merge of this change, following the boundary foundation and TASK/PROJECT public facts; no product behavior is activated | After that merge, implement only `02D`, the ART hidden-preparation public API and private-edge migration |
