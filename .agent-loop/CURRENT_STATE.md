...
| [WS-CI-004](initiatives/WS-CI-004-review-evidence-integrity/STATUS.md) | `WS-CI-004-01` completes on merge with the shared protocol, receipt schema, and read-only review-target sensor | Human review this chunk; do not start reviewer adoption or convergence automatically |
