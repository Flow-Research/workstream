...
|---|---|---|---|---|
| `WS-ART-001` | `WS-ART-001-02C1` | `stopped_after_merge` | `WS-ART-001-02C2` | yes |
| `WS-AUTH-001` | `WS-AUTH-001-REV-CUSTODY` | `stopped_after_merge` | `WS-AUTH-001-PREP` | yes |
| `WS-CON-001` | `WS-CON-001-02A` | `stopped_after_merge` | `WS-CON-001-02B` | yes |
| `WS-ENG-001` | `WS-ENG-001-04A` | `stopped_after_merge` | `WS-ENG-001-04B` | yes |
...
Latest global merge: `c12ba1c8d4bbde86d0e2c19826f5791afc130489`
