...
|---|---|---|---|---|
| `WS-ART-001` | `WS-ART-001-02C2` | `stopped_after_merge` | `WS-ART-001-02C3` | yes |
| `WS-AUTH-001` | `WS-AUTH-001-PREP` | `stopped_after_merge` | `WS-AUTH-001-10` | yes |
...
Latest global merge: `bc5e6a42cc84bff3ec80978970dc0018fe060b35`
