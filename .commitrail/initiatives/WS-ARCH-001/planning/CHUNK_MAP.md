...
| [WS-ARCH-001-03B7](../WS-ARCH-001-03B7.md) | Immutable contributor and management requirements through one historical translator and scoped lock | L1 | Complete; hidden exact contributor visibility and management read; retained HTTP authority replacement remains 03C |
...
| [WS-ARCH-001-03B9](../WS-ARCH-001-03B9.md) | Hidden exact-assignment authority invalidation with committed cause, chronology and same-transaction delivery fence | L1 | Complete; 03C1 exact feature AUTH complete; 03C2 owns atomic producer wiring/registration, then bounded public exposure |
...
| WS-ARCH-001-03C2 | Atomic originating producer publication and first handler registration | L1 | Planned next after 03C1; enforce prefork topology; no retained-event backfill |
| [WS-ARCH-001-03C3/03C4](../WS-ARCH-001-03C-lease-plan.md) | Planned governed claim-relative leases, contributor skip, exact expiry release and foreground guards | L1 | Required before public task completion; duration/lineage precedes release/guards |
| [WS-ARCH-001-03C](chunks/WS-ARCH-001-03C-auth-task-readiness.md) | Remaining exact task/assignment public activation and integrated readiness proof | L1 | Planned after 03C2 and lease/skip 03C3/03C4; replacement precedes physical cleanup |
