...
| [WS-ARCH-001-CP07](../WS-ARCH-001-CP07.md) | PROJECTS hidden activation/binding and replacement readiness guard | L1 | Complete; AUTH-12H live manager authority delivered; ARCH-03A complete internal guide facts delivered; CP08 lineage and minimal writers complete; next ARCH-03B |
| [WS-ARCH-001-CP08](chunks/WS-ARCH-001-CP08-task-attempt-policy-lineage.md) | TASK/Assignment/Submission policy-lineage schema, public facts and minimal existing writers | L1 | Complete; schema and minimal writers delivered together; next ARCH-03B |
...
| [WS-ARCH-001-03A](chunks/WS-ARCH-001-03A-project-current-generation-api.md) | PROJECT current approved unified-generation public facts | L1 | Complete; one active/frozen context port reuses activation custody; CP08 complete; ARCH-03B next |
