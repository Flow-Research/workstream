...
- `backend/scripts/run_test_lanes.py` and new `test_lane_catalogue.py`: extract
...
- `backend/tests/test_ci_test_lanes.py` and new `test_ci_lane_catalogue.py`:
...
inventory and validation, Commitrail records, Markdown links, stale scans and
