...
| R22 | REV migrates its leases before CON's canonical policy-version FK target exists | Critical | REV retains complete lease ownership, but orders 03A2 after merged CON-03B so its non-null immutable FK is valid; no placeholder policy model or nullable retrofit. |
