...
| Database clock mismatch | `test_direct_finalization_clock_mismatch_is_rejected` attempts to commit unequal receipt/setup timestamps and proves the database rejects the transaction | Direct SQL/PostgreSQL; hosted |
