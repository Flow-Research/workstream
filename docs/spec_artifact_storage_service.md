...
and generated byte source. The guide-source binding request contains prepared
authority, one verified content ID, and the exact guide setup generation. The
Submission binding is instead the terminal result of the typed
