...
follow the exact local-grant rules below. The remaining setup endpoints require the
registered covered Project Manager permission or an explicitly authorized
Operator/Audit projection:
