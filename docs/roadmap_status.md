...
replay. ARCH-03C4 adds the three exact-authorized public task queues. ARCH-03C5 adds exact-authorized Contributor/Manager detail and requirements. Next is
...
1. **Integrate the delivered guide/task foundations.** CP08 lineage and
   ...
   ARCH-03C5 supplies exact-authorized detail and requirements. Remaining locked-context/audit read authority
...
Remaining integration
  bounded ARCH-03C remaining locked-context/audit authority
...
- Unified guide: POL-04B1/04B/04B2, POL-05A/AUTH-12F4/POL-05B,
  ...
  exact-authorized Contributor/Manager task detail and requirements. ARCH-04A supplies registered-capability
...
- Contribution lineage: CP05 authorization, CP06 validation and hidden `CP07` activation
  ...
  ARCH-03C5 exposes task detail and requirements; locked-context/audit read
  authority remains pending. Current authority is checked
  on every request.
