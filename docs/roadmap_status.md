...
- Immutable review/revision policy identities, AUTH-owned policy mutation,
  ...
  PREP boundary from WS-ARCH-001-02G; Submission consumption, binding, and the
  public clean cut remain separately gated.
...
- Hidden contributor-ZIP pre-submit execution: fixed-service authority precedes
  ...
  consumption, TASK-owned Submission creation, and final binding are under
  review in 02H; the later public clean cut remains gated.
