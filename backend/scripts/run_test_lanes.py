...
# Direct-file CLI and package/plugin imports share one catalogue.
if __package__ in {None, ""}:
    sys.path.insert(0, str(Path(__file__).resolve().parents[1]))

from scripts.test_lane_catalogue import (  # noqa: E402
    ADMIN_RUNNER_MODULE,
    LANES,
...
def build_manifest(tree_sha: str, nodes: list[str]) -> dict[str, Any]:
    ...
    def lane_for_node(node: str) -> str:
        ...
        partition_lanes = PARTITION_LANES_BY_MODULE.get(module)
