...
SHARED_FOUNDATION_MODULES = (
    ...
    "tests/authorization/guide_activation/test_context.py",
    "tests/authorization/guide_activation/test_prepared.py",
    "tests/authorization/guide_activation/test_postgresql.py",
    "tests/authorization/guide_activation/test_concurrency.py",
    ...
    "tests/migrations/test_task_context_authority.py",
    ...
    "tests/authorization/task_authority/test_audit_contract.py",
    "tests/authorization/task_authority/test_concurrency.py",
    "tests/authorization/task_authority/test_postgresql.py",
    "tests/authorization/task_authority/test_prepared.py",
    "tests/authorization/task_authority/test_public_surface.py",
    "tests/authorization/task_authority/test_submission_policy.py",
    "tests/authorization/task_authority/test_submission_authority.py",
    "tests/authorization/task_authority/test_shared_project_authority.py",
    "tests/authorization/task_authority/test_lifecycle_races.py",
    "tests/authorization/task_authority/test_task_commands.py",
    "tests/authorization/task_authority/test_management_commands.py",
    "tests/authorization/task_authority/test_management_concurrency.py",
    "tests/authorization/task_authority/test_management_authority.py",
    "tests/authorization/task_authority/test_management_contracts.py",
    "tests/authorization/task_authority/test_management_receipts.py",
    ...
    "tests/authorization/guide_compilation/test_schema_contract.py",
    ...
    "tests/authorization/contribution_policies/test_binding_audit_schema.py",
    "tests/authorization/contribution_policies/test_concurrency.py",
    "tests/authorization/contribution_policies/test_cross_owner_lock_order.py",
    "tests/authorization/contribution_policies/test_contracts.py",
    "tests/authorization/contribution_policies/test_policy_audit_schema.py",
    ...
    "tests/outbox/test_contracts.py",
    "tests/outbox/test_delivery_postgresql.py",
    ...
    "tests/outbox/test_delivery_topology.py",
