...
expected = {
    ...
    "task.read": ("task.queue.read", "WS-ARCH-001-03C5"),
    "task.submission_requirements.read": ("task.queue.read", "WS-ARCH-001-03C5"),
    "project.task.read": ("project.task.manage", "WS-ARCH-001-03C5"),
    "project.task.submission_requirements.read": ("project.task.manage", "WS-ARCH-001-03C5"),
    "project.task.locked_context.read": ("project.task.manage", "WS-ARCH-001-03C6"),
    "operations.task.locked_context.read": ("operations.status.read", "WS-ARCH-001-03C6"),
    "audit.task.locked_context.read": ("audit.read", "WS-ARCH-001-03C6"),
    "audit.task.evidence.read": ("audit.read", "WS-ARCH-001-03C7"),
    "task.queue.read": ("task.queue.read", "WS-ARCH-001-03C4"),
    "project.task.queue.read": ("project.task.manage", "WS-ARCH-001-03C4"),
    "operations.task.queue.read": ("operations.status.read", "WS-ARCH-001-03C4"),
    "project.task.create": ("project.task.manage", "WS-ARCH-001-03C3"),
    "project.task.screen": ("project.task.manage", "WS-ARCH-001-03C3"),
    "project.task.release": ("project.task.manage", "WS-ARCH-001-03C3"),
...
AUDIT_ALLOWED_ACTION_VALUES = {
    ...
    "task.read",
    "task.submission_requirements.read",
    "project.task.read",
    "project.task.submission_requirements.read",
    "project.task.locked_context.read",
    "operations.task.locked_context.read",
    "audit.task.locked_context.read",
    "audit.task.evidence.read",
    "task.queue.read",
    "project.task.queue.read",
    "operations.task.queue.read",
    "project.task.create",
    "project.task.screen",
