...
def test_exact_active_action_inventory():
    ...
    assert {
        ...
        ActionId.PROJECT_TASK_READ,
        ActionId.PROJECT_TASK_SUBMISSION_REQUIREMENTS_READ,
        ...
        ActionId.PROJECT_TASK_CREATE,
        ActionId.PROJECT_TASK_SCREEN,
        ActionId.PROJECT_TASK_RELEASE,
